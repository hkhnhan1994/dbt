...
AND  FTE.TRANSACTION_EVENT_USER_TRANSACTION_TIME >= TIMESTAMP(DATETIME( '{{begin_date}}', '{{time_zone}}'))
AND  FTE.TRANSACTION_EVENT_USER_TRANSACTION_TIME < TIMESTAMP(DATETIME( '{{end_date}}', '{{time_zone}}'))
